...
const faviconMapper: { [key: string]: string } = {
  '(?:github.com)': 'https://wes1ey.cc/favicons/github.png',
  '((?:t.co)|(?:twitter.com))': 'https://wes1ey.cc/favicons/twitter.png',
  'coolshell.cn': 'https://wes1ey.cc/favicons/coolshell.png',
  'vercel.com': 'https://wes1ey.cc/favicons/vercel.png',
  'nextjs.org': 'https://wes1ey.cc/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://wes1ey.cc/favicon_blank.png'
